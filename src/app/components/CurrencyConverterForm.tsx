...
export default function CurrencyConverterForm({ className = '' }: CurrencyConverterFormProps) {
  // State management
  ...
  const fetchAvailableCurrencies = async () => {
    try {
      ...
      const response = await fetch('/api/rates?include_currencies=true');
      ...
      if (data.success && data.data && data.data.supportedCurrencies) {
        setAvailableCurrencies(data.data.supportedCurrencies);
        console.log('Successfully loaded currencies:', data.data.supportedCurrencies.length);
      } else {
      ...
      setAvailableCurrencies(['USD', 'EUR', 'GBP', 'JPY', 'AUD', 'CAD', 'CHF', 'CNY']);
    } finally {
